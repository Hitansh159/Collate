        ...
        <div class="card shadow-lg bg-base-100 m-2">
            <div class="card-body">
                ...
                <div class="form-control">
                    ...
                    <textarea class="textarea h-24 textarea-bordered textarea-primary text-black dark:text-white" placeholder={`Enter your ${groupName}`} disabled={!state.edit} onChange={changeHandeler} value={state[groupName][id]}></textarea>
                </div>
            </div>
        </div>
    )
